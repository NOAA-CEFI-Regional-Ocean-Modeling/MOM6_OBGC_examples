...
fremake -f -F -x ocean_ice_cobalt_experiments.xml -p ncrc5.intel22 -t ${TARGET} MOM6_SIS2_GENERIC_4P_compile_symm
jobid=$(sbatch --parsable ${DEV}/${USER}/github/cefi_NWA12_regression_${CURRENT_DATE}/MOM6_SIS2_GENERIC_4P_compile_symm/ncrc5.intel22-${TARGET}/exec/compile_MOM6_SIS2_GENERIC_4P_compile_symm.csh | awk -F';' '{print $1}' | cut -f1)
...
executable_file="${DEV}/${USER}/github/cefi_NWA12_regression_${CURRENT_DATE}/MOM6_SIS2_GENERIC_4P_compile_symm/ncrc5.intel22-${TARGET}/exec/fms_MOM6_SIS2_GENERIC_4P_compile_symm.x"
if [ -f "$executable_file" ]; then
    ...
    echo "Please check ${DEV}/${USER}/github/cefi_NWA12_regression_${CURRENT_DATE}/MOM6_SIS2_GENERIC_4P_compile_symm/ncrc5.intel22-${TARGET}/exec/compile_MOM6_SIS2_GENERIC_4P_compile_symm.csh.o$jobid"
    exit 1
fi
...
frecheck -v -x ocean_ice_cobalt_experiments.xml -p ncrc5.intel22 -r NWA12_RT -t ${TARGET} NWA12_COBALT_V1 > check.log
...
diff -q ./19930101.extra.results/MOM_parameter_doc.all /gpfs/f5/cefi/proj-shared/github/ci_data/reference/NWA12_RT/stable/${ref_date}/3day/${TARGET}/1x0m3d_1646x1o/ascii/19930101.extra.results/MOM_parameter_doc.all > /dev/null || { echo "Error: MOM_parameter_doc.all are different, check and update ref! Exiting now..."; exit 1; }
# SIS_parameter_doc.all
diff -q ./19930101.extra.results/SIS_parameter_doc.all /gpfs/f5/cefi/proj-shared/github/ci_data/reference/NWA12_RT/stable/${ref_date}/3day/${TARGET}/1x0m3d_1646x1o/ascii/19930101.extra.results/SIS_parameter_doc.all > /dev/null || { echo "Error: SIS_parameter_doc.all are different, check and update ref! Exiting now..."; exit 1; }
# ocean.stats
diff -q ./19930101.extra.results/ocean.stats /gpfs/f5/cefi/proj-shared/github/ci_data/reference/NWA12_RT/stable/${ref_date}/3day/${TARGET}/1x0m3d_1646x1o/ascii/19930101.extra.results/ocean.stats > /dev/null || { echo "Error: ocean.stats are different, check and update ref! Exiting now..."; exit 1; }
